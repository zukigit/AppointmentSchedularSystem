...
@Component({
  ...
  templateUrl: './appointment-detail-view-byuser.component.html',
  styleUrls: ['./appointment-detail-view-byuser.component.scss']
})
export class AppointmentDetailViewByuserComponent implements OnInit {
  ...
  //update
  updateApp() {
    this.router.navigate(['user/update-app-byuser',this.id], { queryParams: { data: JSON.stringify(this.date)}});
  }
